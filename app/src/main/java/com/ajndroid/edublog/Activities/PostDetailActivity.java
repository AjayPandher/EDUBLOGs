...
import com.ajndroid.edublog.Adapters.CommentAdapter;
import com.ajndroid.edublog.Models.Comment;
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = getLayoutInflater().inflate(R.layout.activity_post_detail, null);
...
imgPost.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
      // Intent intent = new Intent(PostDetailActivity.this,FullscreenActivity.class);
...
// add Comment button click listner
        ...
        btnAddComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               String uimg;
                uimg = firebaseUser.getPhotoUrl() != null ? firebaseUser.getPhotoUrl().toString() : null;
